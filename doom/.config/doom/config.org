...
- [[#keybindings][Keybindings]]
  - [[#toggle][Toggle]]
  - [[#open][Open]]
  - [[#open-url-with-gx][Open URL with gx]]
- [[#markdown][Markdown]]
  - [[#headers][Headers]]
...
* Keybindings
Leader keys and custom shortcuts.
...
** Open URL with gx
Open the URL/link at point with ~gx~, like in LazyVim.  This overrides Doom's default ~gx~ (~evil-exchange~).  In Org buffers this calls ~org-open-at-point~ so Org links work, otherwise it calls ~browse-url-at-point~.
...
* Org
Org directory and display tweaks.
...
* Sensible Defaults
Base defaults I want everywhere.
...
* Ghostel
Ghostel terminal setup with Evil keys.
...
* JSONC Mode
Open .jsonc files with jsonc-mode.
